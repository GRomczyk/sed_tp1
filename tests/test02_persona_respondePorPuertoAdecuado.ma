[Top]
%En este test esperamos que la persona responda por el puerto adecuado
%es decir, por el que le hablaron
components : P1@Persona
out : out_port1 out_port2 out_port3 out_port4 out_port5 info_out1
in : in_port1 in_port2 in_port3 in_port4 in_port5 info
